...
<html lang="en">
    ...
    <body class="empcolor">
        ...
        <div class="page-heading-title">
            <h3>Categories</h3>
            <a href="category-form.php" class="stage_class"><i class="fa fa-plus"></i> Add Category</a>
         </div>
                 ...
                 <?php if (count($get_listing) > 0) {
                  ...
                  <tr>
                    <td><?php echo $i++; ?></td>
                     ...
                     <td>
                        <a href="category-form.php?id=<?php echo $value["id"]; ?>"><i class="fa fa-edit"></i></a>
                        <a href="delete-category.php?id=<?php echo $value["id"]; ?>"><i class="fa fa-trash"></i></a>
                     </td>
                  </tr>
                  <?php
                        }
