...
if(!isset($_SESSION['id'])){
   ...
   if (isset($_POST['add'])) {
      ...
      //Query to execute
      $sql_query = "INSERT INTO `brands`(`name`,`status`) VALUES ('".$name."','".$status."')";
      ...
      if($execute_query){
         ...
         echo "<script>alert('There's problem in adding brand')</script>";
         echo "<script>window.location.href ='brand-form.php'</script>";
      }
   }
   ...
   if (isset($_POST['edit'])) {
      ...
      $sql = "UPDATE brands SET name = '$name', status = '$status' WHERE id='$id'";
   ...
   <?php include('include/sidebar.php'); ?>
      ...
      <section class="page_wrapper">
        ...
        <?php include('include/header.php'); ?>
         ...
         <form action="brand-form.php" method="post">
